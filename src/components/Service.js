...
function Service() {
    return (
        <section className="flex-col items-center justify-center py-24 overflow-hidden bg-right bg-no-repeat feature-bg">
                ...
                <div className="z-20 flex w-full flex-col lg:w-[60%]">
                    ...
                    <ul className="grid gap-10 mt-10 md:grid-cols-2 lg:mt-20 lg:gap-20">
                        <li className="flex flex-col items-start flex-1 w-full">
                            <div className="p-4 rounded-full bg-greenLigth-app lg:p-7">
                                <Image src='' alt="map" width={28} height={28} />
                            </div>
